...
class LinkR(ConfigManger):
    ...
    def gen_junit(self):
        ...
        self._gen_polarion_property_file()
    ...
    def _gen_polarion_property_file(self):
        """
        Generate a simple mapping file.
        :return: polarion.properties
        """
        with open(self.args.props_file, 'w') as prop_file:
            prop_file.write("polarion.run={}\n".format(self.args.test_run))
            for tc_id in self.args.tc:
                prop_file.write("{}={}\n".format(tc_id, tc_id))
            prop_file.close()
    ...
    def _upload(self):
        ...
        """
        polarion_request = post(self.polarion_url,
                                data=self.args.output_f,
                                auth=auth.HTTPBasicAuth(self.username,
                                                        self.password))
...
def main():
    ...
    parser.add_argument("-u", "--upload_results", metavar="",
                        dest="ur", type=bool,
